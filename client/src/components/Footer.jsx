...
const Footer = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        ...
        <div className="flex-1 flex items-start md:justify-end gap-20">
            <div>
                ...
                <ul className="text-sm space-y-2">
                    ...
                    <li><a href="mailto:poulomidas2801@gmail.com" className="hover:text-gray-300">Contact us</a></li>
            ...
            <div>
                ...
                <div className="text-sm space-y-2">
                    ...
                    <div className="flex items-center gap-2 pt-4">
                        ...
                        <button className="bg-primary w-24 h-9 text-white rounded cursor-pointer hover:text-gray-300">Subscribe</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        Copyright 2025 © <a href="https://prebuiltui.com">QuickAI- PD</a>. All Right Reserved.
        </p>
    </footer>
  )
}
